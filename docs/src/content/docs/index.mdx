...
hero:
  ...
  actions:
    - text: Get Started
      ...
      variant: primary
    - text: View on GitHub
      link: https://github.com/rahulroy0322/StratusTS
      icon: external
      variant: minimal
---
...
- **GitHub**: [rahulroy0322/structure-ts](https://github.com/rahulroy0322/StratusTS)
- **Issues**: [Report bugs or request features](https://github.com/rahulroy0322/StratusTS/issues)
- **Discussions**: [Join the conversation](https://github.com/rahulroy0322/StratusTS/discussions)
