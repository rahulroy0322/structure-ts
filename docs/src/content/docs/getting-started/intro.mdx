---
title: Introduction
description: Why Structure-Ts exists and what problems it solves
---
import { Code } from '@astrojs/starlight/components';

# Introduction

Welcome to `Structure-Ts`! This page explains why this framework exists, what problems it solves, and whether it's the right choice for your project.
...
**Structure-Ts** fills this gap by bringing Django's proven architecture to TypeScript:
...
Structure-Ts is built on three core beliefs:

### 1. Convention over Configuration

You shouldn't spend hours configuring your framework before writing a single line of business logic. Structure-Ts provides sensible defaults that work for **`90%`** of use cases.
...
Large applications are easier to manage when divided into focused modules. Each "app" in Structure-Ts handles one domain:
...
Structure-Ts might not be the best fit if you:
...
1. **[Installation](/getting-started/installation/)** - Set up Structure-Ts
...
Five minutes from idea to working endpoint. That's the Structure-Ts way.

## Current Status

Structure-Ts is actively developed and evolving:
...
- **GitHub Issues**: [Report bugs or ask questions](https://github.com/rahulroy0322/structure-ts/issues)
- **GitHub Discussions**: [Community Q&A](https://github.com/rahulroy0322/structure-ts/discussions)

## Ready to Begin?

Now that you understand what structure-ts is and why it exists, let's get you set up!

➡️ **Next Step**: [Install Structure-Ts](/getting-started/installation/)
