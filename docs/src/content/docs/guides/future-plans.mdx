---
title: Future Plans
description: Roadmap and upcoming features for StratusTS
---
...
```typescript
// Planned API
import { createTestApp } from 'stratus-ts/testing';
...
{/* **Examples:**
- stratus-ts-auth (authentication)
- stratus-ts-admin (admin panel)
- stratus-ts-analytics (analytics)
- stratus-ts-search (full-text search) */}
...
1. **Search existing requests**: Check [GitHub Issues](https://github.com/rahulroy0322/StratusTS/issues) first 🔍
2. **Open a discussion**: Share your idea in [Discussions](https://github.com/rahulroy0322/StratusTS/discussions) 💬
