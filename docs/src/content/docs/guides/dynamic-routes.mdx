...
Dynamic routing is currently implemented with typed parameter syntax. 
Parameter value **`conversation`** is under development.
...
Found a bug? [Open an issue](https://github.com/rahulroy0322/StratusTS/issues)
...
Want a feature? [Start a discussion](https://github.com/rahulroy0322/StratusTS/discussions)
